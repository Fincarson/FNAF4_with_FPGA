    ...
    always @(*) begin
        ...
        if(main_state != GAME) next_position = KITCHEN;
            ...
            case({position_in, night_level})
                {KITCHEN, night_1}: next_position = (sec_count >= 10'd5) ? LEFT_HALLWAY : KITCHEN;
                {KITCHEN, night_2}: next_position = (sec_count >= 10'd4) ? LEFT_HALLWAY : KITCHEN;
                {KITCHEN, night_3}: next_position = (sec_count >= 10'd3) ? LEFT_HALLWAY : KITCHEN;
                {KITCHEN, night_4}: next_position = (sec_count >= 10'd2) ? LEFT_HALLWAY : KITCHEN;
                {KITCHEN, night_5}: next_position = (sec_count >= 10'd1) ? LEFT_HALLWAY : KITCHEN;
                
                {LEFT_HALLWAY, night_1}: next_position = (sec_count >= 10'd5 && player_position != LEFT_DOOR) ? LEFT_DOOR : LEFT_HALLWAY;
                {LEFT_HALLWAY, night_2}: next_position = (sec_count >= 10'd4 && player_position != LEFT_DOOR) ? LEFT_DOOR : LEFT_HALLWAY;
                {LEFT_HALLWAY, night_3}: next_position = (sec_count >= 10'd3 && player_position != LEFT_DOOR) ? LEFT_DOOR : LEFT_HALLWAY;
                {LEFT_HALLWAY, night_4}: next_position = (sec_count >= 10'd2 && player_position != LEFT_DOOR) ? LEFT_DOOR : LEFT_HALLWAY;
                {LEFT_HALLWAY, night_5}: next_position = (sec_count >= 10'd1 && player_position != LEFT_DOOR) ? LEFT_DOOR : LEFT_HALLWAY;
                
                default: next_position = position_in;
            endcase
            if(player_position == LEFT_DOOR && position_in == LEFT_DOOR && keyboard == KEY_SPACE) next_position = KITCHEN;
        end 
    end
